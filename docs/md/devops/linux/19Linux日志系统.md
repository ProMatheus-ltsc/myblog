...
![image-20220531200451984](./image-20220531200451984.png)
...
![image-20220531200514635](./image-20220531200514635.png)
...
![image-20220531200524878](./image-20220531200524878.png)

成功的执行之后我们再来查看两个日志的内容变化：

![image-20220531200529587](./image-20220531200529587.png)
...
![image-20220531200533998](./image-20220531200533998.png)

我们查看的方法是使用 last 与 lastlog 工具来提取其中的信息

![image-20220531200538410](./image-20220531200538410.png)
...
![image-20220531200546855](./image-20220531200546855.png)
...
![image-20220531200553386](./image-20220531200553386.png)

![image-20220531200558273](./image-20220531200558273.png)

也不知道他在写什么，我们还是来看看 rsyslog 的结构框架，数据流的走向吧。

![image-20220531200603207](./image-20220531200603207.png)
...
![image-20220531200610371](./image-20220531200610371.png)
...
![image-20220531200628527](./image-20220531200628527.png)
...
![image-20220531200633772](./image-20220531200633772.png)
...
![image-20220531200640533](./image-20220531200640533.png)
